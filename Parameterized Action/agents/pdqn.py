...
class QActor(nn.Module):
    ...
    def __init__(self, state_size, action_size, action_parameter_size, hidden_layers=(100,), action_input_layer=0,
        ...
        ## We have both action and action-parameters in this. 
        ...
        ## We used the action-parameter size in the input.
        ## And we ended with the action_size as the output.

        ## At the end we are getting an action.
    ...
    def forward(self, state, action_parameters):
        ...
        ## we contactenate the state and action_parameters to input them.
...
class ParamActor(nn.Module):
    ...
    def __init__(self, state_size, action_size, action_parameter_size, hidden_layers, squashing_function=False,
        ...
        ## we get the states as the input
        ...
        ## there is no output layer. But these 2 separate layers.
        ## and these both layers predict the parameters of action.
    ...
    def forward(self, state):
        ...
        ## how are they using these layers as a function.
...
class PDQNAgent(Agent):
    ...
    def _optimize_td_loss(self):
        ...
        ## we have same optimizer for both actor and critic.
